...
[0,4,8,10,14,16,18,26,36,80]};%phi=0.02%%%%%%%%%%%

% t_best_OUSob={[10,16,34]
% [0,10,16,34]
% [0,10,16,30,80]
% [0,8,12,16,30,80]
% [0,8,10,14,18,30,80]
...
% [0,4,8,10,14,16,18,26,38,80]
% };%phi=0.13

% t_best_OUSob={[8,16,80]
% [8,16,58,80]
% [8,14,18,58,80]
% [8,14,18,48,64,80]
% [8,14,18,40,54,68,80]
% [8,12,16,20,38,52,66,80]
% [8,12,16,20,36,46,60,70,80]
% [8,12,16,20,32,42,50,62,70,80]
%     };%phi=0.3
...
% t_best_OUFIM={[6.66271755138768,16.4733946534838,79.9980822078150]
% [6.64497386280119,16.4460439168094,46.8761308553549,79.9999913980120]
% [6.60164189301587,16.3677692921305,37.2322136818162,58.4837416177392,79.9999970435514]
% [5.38690052641794,12.1154415256908,18.2989211777153,38.4505053504152,59.1171785006693,79.9999971471583]
% [3.98386428299860,9.12451185278407,14.8755295397838,20.3541010507537,39.5540062811391,59.6865251455673,79.9999972582156]
% [3.85404865609391,8.87826997719615,14.4873487730314,19.5999832392054,34.3986461528143,49.3750830129195,64.6737455881554,79.9999981662429]
% [3.74553268309902,8.69022149623592,14.1723112329843,19.0493607550615,30.2476287380896,42.3183830127156,54.8230324083888,67.4068456033768,79.9999984605630]
% [2.96121299571617,7.44260439199061,11.8292835328466,16.0132815833252,20.6081487674262,32.1338318486205,43.8160578930791,55.8354156232932,67.9139345861890,79.9999985169138] }; 
%phi=0.13

% t_best_OUFIM={[6.36723891172627,16.7688653982681,79.9986071525487]
% [6.36397141146092,16.7639765289207,56.9626120254782,79.9999473761585]
% [5.18595319182614,12.4114840891951,18.9437907073980,57.2118687182278,79.9999581175490]
% [5.06374548773600,12.0852894808343,18.6470207883372,46.6586588622572,63.3981368286787,79.9999882066057]
% [3.41352303043177,8.75720065759691,15.0060146184571,20.5951811783515,46.9427804528843,63.5392652355986,79.9999883381064]
% [3.35004430274360,8.65051872453943,14.8484625327701,20.2983081596130,40.4720950167054,53.8333253398466,66.9282316398006,79.9999945928122]
% [2.47477299428098,7.38276156228197,12.5097650381060,17.2215565521428,22.6999243589474,41.1504327853540,54.2705105860569,67.1463693712595,79.9999947463248]
% [2.30147049008858,7.14704428589640,12.0937168593999,16.7721665673763,21.9071333325716,36.3160839959740,47.5683220101467,58.4174814095877,69.2124491202706,79.9999965671134]
% };%phi=0.3
...
% t_vec={t_even,t_best_IIDFIM,t_best_OUFIM,t_best_OUSob};
...
%       plot(set_numpoints, CI_w(:,j), '*--',set_numpoints, CI_w(:,j+num_param*1), 'x:',...
%      set_numpoints, CI_w(:,j+num_param*2), 'o--',  set_numpoints, CI_w(:,j+num_param*3), 'd:', 'MarkerFaceColor', 'c', 'MarkerSize',8,'LineWidth', 1.5);
% 
%       xlim([set_numpoints(index1(1)),set_numpoints(end)]);
%       xlabel('Number of Points');
%      if j==1
%           ylabel('Confidence Interverl Widths');%Main program to compute the average CI and estimated parameters
%      end
