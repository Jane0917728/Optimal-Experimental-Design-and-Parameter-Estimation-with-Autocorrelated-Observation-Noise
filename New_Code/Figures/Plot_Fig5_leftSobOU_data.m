%%%%%%%%%%%%%%%%%%Optimal experimental design for OU noise with Sob objective fucntion.
%Decision variables:  measurement points 
%This program generate the data t_best for the left-hand plots in Figure 3
%for OU noise with Sob
r=0.2; K=50; N0=4.5;
phi=0.12;% parameter of OU
t_interval=2;
t_initial=0;
TF=80+t_initial;
...
percent=[0.15, 0.1, 0.15];
lower_bounds = prm'.* (1-percent);
upper_bounds = prm'.* (1+percent); 
num_MC=30000;% number of Monte Carlo 
