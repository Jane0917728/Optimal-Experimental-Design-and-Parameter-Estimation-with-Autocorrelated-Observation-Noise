...
for k=1:num_param
    ...
    plot(SigmaC,CI_w(:,k),'-o',SigmaC,CI_w(:,k+num_param*1),'--o', SigmaC, CI_w(:,k+num_param*2),'-.o','MarkerSize',6,'LineWidth',2);
